...
<ComponentPreview component={<EffectPreview slug="rectangular-text-reveal" />} code={effectExamples["rectangular-text-reveal"]} description="Use Reload component to replay the reveal." previewClassName="p-0 sm:p-0" />

## Install using CLI

<CLICommand componentName="rectangular-text-reveal" />
...
<Dependencies step={2} title="Copy the source code" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/rectangular-text-reveal.jsx</code></p>
