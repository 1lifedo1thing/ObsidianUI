...
<ComponentPreview component={<EffectPreview slug="arrow-fill-button" />} code={effectExamples["arrow-fill-button"]} description="Hover or focus the button to see its fill animation." previewClassName="p-0 sm:p-0" />

## Install using CLI

<CLICommand componentName="arrow-fill-button" />
...
<Dependencies step={2} title="Copy the source code" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/arrow-fill-button.jsx</code></p>
...
<Dependencies step={3} title="Add the CSS file" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/arrow-fill-button.css</code></p>
