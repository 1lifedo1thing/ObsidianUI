...
<ComponentPreview
  ...
  code={`import FlipText from '@/components/block/flip-text'
...
<Dependencies step={2} title="Copy the source code" source="flip-text">
    <p className="text-[13px] text-muted-foreground mt-2 mb-4">Copy into <code className="text-foreground font-mono text-xs bg-neutral-100 dark:bg-[#161616] px-2 py-1 rounded-md">components/block/flip-text.tsx</code></p>
</Dependencies>
