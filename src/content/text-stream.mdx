...
<ComponentPreview component={<EffectPreview slug="text-stream" />} code={effectExamples["text-stream"]} description="Scroll the page to change the stream’s momentum." previewClassName="p-0 sm:p-0" />

## Install using CLI

<CLICommand componentName="text-stream" />
...
<Dependencies step={2} title="Copy the source code" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/text-stream.jsx</code></p>
...
<Dependencies step={3} title="Add the CSS file" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/text-stream.css</code></p>
