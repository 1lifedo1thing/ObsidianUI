...
<ComponentPreview component={<EffectPreview slug="magnetic-image-trail" />} code={effectExamples["magnetic-image-trail"]} description="Move your cursor across the preview." previewClassName="p-0 sm:p-0" />

## Install using CLI

<CLICommand componentName="magnetic-image-trail" />
...
<Dependencies step={2} title="Copy the source code" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/magnetic-image-trail.jsx</code></p>
