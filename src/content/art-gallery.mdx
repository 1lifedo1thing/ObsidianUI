...
<ComponentPreview component={<EffectPreview slug="art-gallery" />} code={effectExamples["art-gallery"]} description="Drag inside the preview to pan the gallery." previewClassName="p-0 sm:p-0" />

## Install using CLI

<CLICommand componentName="art-gallery" />
...
<Dependencies step={2} title="Copy the source code" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/block/art-gallery.jsx</code></p>
...
<Dependencies step={3} title="Add the supporting file" className="docs-source-card">
  <p className="mb-4 text-sm text-muted-foreground">Copy into <code className="rounded-full bg-muted px-2 py-1 font-mono text-xs text-foreground">components/ui/ripple-pulse-loader.tsx</code></p>
