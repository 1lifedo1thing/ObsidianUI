...
<ComponentPreview
  ...
  code={`import JellyLoader from '@/components/block/jelly-loader'
...
<Dependencies step={2} title="Copy the source code" source="jelly-loader">
    <p className="text-[13px] text-muted-foreground mt-2 mb-4">Copy into <code className="text-foreground font-mono text-xs bg-neutral-100 dark:bg-[#161616] px-2 py-1 rounded-md">components/block/jelly-loader.tsx</code></p>
</Dependencies>
