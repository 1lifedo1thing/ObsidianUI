...
import { Home, User, Calendar, Menu, X, Sun, Moon } from "lucide-react"
...
const Navbar = ({ className, logo, ...props }: React.HTMLAttributes<HTMLElement> & { logo?: React.ReactNode }) => {
    ...
    <>
          ...
          <div className="flex-1 h-full relative min-w-0 -ml-px">
            ...
            <div className="relative w-full h-full flex items-end justify-between md:justify-center pb-2 px-4 md:px-8 md:gap-12">
              ...
              <button
                ...
                aria-controls="playground-mobile-navigation"
              >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <nav id="playground-mobile-navigation" aria-label="Mobile navigation" className="flex flex-col gap-2" onKeyDown={(event) => { if (event.key === "Escape") { setIsMobileMenuOpen(false); menuButtonRef.current?.focus(); } }}>
              {/* Combine all items */}
