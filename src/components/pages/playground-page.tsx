...
import Button1 from "@/components/block/playground-button";
import { Navbar1 } from "@/components/block/playground-navbar"; // Keep for registry list but not as main nav
import { SmoothScroll } from "@/components/block/smooth-scroll";

const PlaygroundNavbarPreview = () => (
  <Navbar1 items={[
    { name: "Home", href: "/" },
...
const components = [
  {
    ...
    category: "Navigation",
    component: PlaygroundNavbarPreview,
  },
  {
    id: "button1",
    title: "Button 1",
    ...
    >
      ...
      <div className="p-6 space-y-3">
        ...
        <div className="flex items-center gap-2 pt-2">
          <Link href="/docs/installation" className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-primary/80 transition-colors">
            Installation guide
  ...
  return (
    <SmoothScroll>
      <div className="min-h-screen bg-background overflow-hidden noScrollbar">
        ...
        <main id="main-content" className="px-4 md:px-20 pt-32 pb-20">
          {/* Header */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
