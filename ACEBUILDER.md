...
- For default prop values that point to Cloudflare R2 assets, **hard-code the direct CDN URL** (e.g. `https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/...`) rather than calling `r2()`.
