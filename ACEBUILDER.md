...
- For default prop values that point to Cloudflare R2 assets, **hard-code the direct CDN URL** (e.g. `https://cdn-new.obsidianui.dev/effects/...?v=3`) rather than calling `r2()`.
