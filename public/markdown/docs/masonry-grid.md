# ObsidianUI — Masonry Grid

[Canonical page](https://www.obsidianui.dev/docs/masonry-grid) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A responsive masonry-style image grid with hover animations and lightbox support.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/masonry-grid)
...
Download the complete manifest: [masonry-grid.json](https://www.obsidianui.dev/r/masonry-grid.json). It includes every required local file and package dependency.
...
### components/block/masonry-grid.tsx

Installation target: `@components/block/masonry-grid.tsx`
