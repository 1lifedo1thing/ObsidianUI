# ObsidianUI — Book Flip

[Canonical page](https://www.obsidianui.dev/docs/book-flip) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A tactile 3D book with bending pages, realistic light, and interactive page turns.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/book-flip)

Select a page or click the book to turn it.
...
Download the complete manifest: [book-flip.json](https://www.obsidianui.dev/r/book-flip.json). It includes every required local file and package dependency.

Install the listed package dependencies in your React project:

```bash
npm install @react-three/drei @react-three/fiber clsx maath tailwind-merge three
```
...
### lib/effects/book-flip/Book.jsx

Installation target: `@lib/effects/book-flip/Book.jsx`
...
### lib/effects/book-flip/Experience.jsx

Installation target: `@lib/effects/book-flip/Experience.jsx`
...
### lib/effects/book-flip/PageContext.jsx

Installation target: `@lib/effects/book-flip/PageContext.jsx`
