# ObsidianUI — Butterfly Trail Cursor

[Canonical page](https://www.obsidianui.dev/docs/butterfly-trail-cursor) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

Animated butterflies lift away from the pointer with soft wing motion and fading trails.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/butterfly-trail-cursor)
...
Download the complete manifest: [butterfly-trail-cursor.json](https://www.obsidianui.dev/r/butterfly-trail-cursor.json). It includes every required local file and package dependency.
