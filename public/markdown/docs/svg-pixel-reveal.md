...
export default function Demo() {
  ...
  return <div ref={scroller} tabIndex={0} aria-label="Scroll effect preview" className="relative h-[400px] overflow-y-auto overscroll-contain" style={{ containerType: "size" }}>
    ...
    <SvgPixelReveal src="https://cdn-new.obsidianui.dev/effects/svg-pixel-reveal/svg-pixel-reveal-img01.png?v=3" alt="Landscape photograph" scroller={scroller} start="top 35%" style={{ width: "86%", height: "70cqh", margin: "0 auto" }} />
