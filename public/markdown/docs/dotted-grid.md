# ObsidianUI — Dotted Grid

[Canonical page](https://www.obsidianui.dev/docs/dotted-grid) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

An animated dot field transforms between geometric shapes and responds to your cursor with a glowing trail.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/dotted-grid)

Move across the grid to draw a trail.
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/dotted-grid.json"
```
...
Download the complete manifest: [dotted-grid.json](https://www.obsidianui.dev/r/dotted-grid.json). It includes every required local file and package dependency.
...
### components/block/dotted-grid.jsx

Installation target: `@components/block/dotted-grid.jsx`
...
Move across the grid to draw a trail. The effect stays inside its container and respects reduced motion preferences.
