# ObsidianUI — Marquee on SVG Path

[Canonical page](https://www.obsidianui.dev/docs/svg-path-marquee) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

Images follow a looping SVG curve with drag momentum and scroll-responsive speed.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/svg-path-marquee)

Drag the images or use the arrow keys while the path is focused.
...
const images = [
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img01.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img02.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img03.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img04.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img05.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img06.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img07.png",
  "https://pub-830233752de349e29c6104a501b309d4.r2.dev/effects/svg-path-marquee/svg-path-marquee-img08.png"
];
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/svg-path-marquee.json"
```
...
Download the complete manifest: [svg-path-marquee.json](https://www.obsidianui.dev/r/svg-path-marquee.json). It includes every required local file and package dependency.
...
### components/block/svg-path-marquee.jsx

Installation target: `@components/block/svg-path-marquee.jsx`
...
Drag the images or use the arrow keys while the path is focused. The effect stays inside its container and respects reduced motion preferences.
