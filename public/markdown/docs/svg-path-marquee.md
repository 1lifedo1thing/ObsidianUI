...
const images = [
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img01.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img02.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img03.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img04.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img05.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img06.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img07.png",
  "https://cdn-new.obsidianui.dev/effects/svg-path-marquee/svg-path-marquee-img08.png"
];
