# ObsidianUI — Hover Slider

[Canonical page](https://www.obsidianui.dev/docs/interactive-hover-slider) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

An editorial list reveals a curved image stack with elastic image transitions.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/interactive-hover-slider)

Hover or focus a project row to reveal its image.
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/interactive-hover-slider.json"
```
...
Download the complete manifest: [interactive-hover-slider.json](https://www.obsidianui.dev/r/interactive-hover-slider.json). It includes every required local file and package dependency.

Install the listed package dependencies in your React project:

```bash
npm install clsx gsap tailwind-merge three
```
...
const defaultItems = [
 { id: "01", title: "Soft Forms", focus: "Visual study", year: "2026", img: "https://cdn-athrix.milliondollarinternet.lol/effects/interactive-hover-slider/interactive-hover-slider-img01.webp" },
 { id: "02", title: "Botanical", focus: "Art direction", year: "2026", img: "https://cdn-athrix.milliondollarinternet.lol/effects/interactive-hover-slider/interactive-hover-slider-img02.webp" },
 { id: "03", title: "Afterlight", focus: "Identity", year: "2026", img: "https://cdn-athrix.milliondollarinternet.lol/effects/interactive-hover-slider/interactive-hover-slider-img03.webp" },
 { id: "04", title: "Glasswork", focus: "Materials", year: "2026", img: "https://cdn-athrix.milliondollarinternet.lol/effects/interactive-hover-slider/interactive-hover-slider-img04.png" },
 { id: "05", title: "Motion Study", focus: "Experiment", year: "2026", img: "https://cdn-athrix.milliondollarinternet.lol/effects/interactive-hover-slider/interactive-hover-slider-img05.png" },
];
...
### lib/effects/shared/webgl-surface.jsx

Installation target: `@lib/effects/shared/webgl-surface.jsx`
...
Hover or focus a project row to reveal its image. The effect stays inside its container and respects reduced motion preferences.
