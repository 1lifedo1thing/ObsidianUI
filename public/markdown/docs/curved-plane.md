# ObsidianUI — Curved Plane

[Canonical page](https://www.obsidianui.dev/docs/curved-plane) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

An image carousel whose edges curve and stretch with your drag and scroll velocity.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/curved-plane)

Drag the images or scroll over the canvas.
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/curved-plane.json"
```
...
Download the complete manifest: [curved-plane.json](https://www.obsidianui.dev/r/curved-plane.json). It includes every required local file and package dependency.
...
Drag the images or scroll over the canvas. The effect stays inside its container and respects reduced motion preferences.
