# ObsidianUI — Fractal Glass

[Canonical page](https://www.obsidianui.dev/docs/fractal-glass) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

Glass strips refract an image with fractal distortion and pointer-driven parallax.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/fractal-glass)

Move your pointer across the glass.
...
Download the complete manifest: [fractal-glass.json](https://www.obsidianui.dev/r/fractal-glass.json). It includes every required local file and package dependency.
