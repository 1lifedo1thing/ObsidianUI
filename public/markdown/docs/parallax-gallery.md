# ObsidianUI — Parallax Gallery

[Canonical page](https://www.obsidianui.dev/docs/parallax-gallery) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A framed gallery with rotating photographs, moving side thumbnails, and scroll snapping.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/parallax-gallery)
...
const images = [
  "https://cdn-athrix.milliondollarinternet.lol/effects/parallax-gallery/parallax-gallery-img01.jpg",
  "https://cdn-athrix.milliondollarinternet.lol/effects/parallax-gallery/parallax-gallery-img02.jpg",
  "https://cdn-athrix.milliondollarinternet.lol/effects/parallax-gallery/parallax-gallery-img03.jpg",
  "https://cdn-athrix.milliondollarinternet.lol/effects/parallax-gallery/parallax-gallery-img04.jpg"
];
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/parallax-gallery.json"
```
...
Download the complete manifest: [parallax-gallery.json](https://www.obsidianui.dev/r/parallax-gallery.json). It includes every required local file and package dependency.
...
### components/block/parallax-gallery.jsx

Installation target: `@components/block/parallax-gallery.jsx`
