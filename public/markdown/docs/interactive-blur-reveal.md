# ObsidianUI — Interactive Blur Reveal

[Canonical page](https://www.obsidianui.dev/docs/interactive-blur-reveal) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A frosted image becomes clear beneath a fluid cursor trail, with noise distortion and subtle grain.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/interactive-blur-reveal)

Move over the image to reveal its detail.
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/interactive-blur-reveal.json"
```
...
Download the complete manifest: [interactive-blur-reveal.json](https://www.obsidianui.dev/r/interactive-blur-reveal.json). It includes every required local file and package dependency.
...
export function InteractiveBlurReveal({
  imageSrc = "https://cdn-new.obsidianui.dev/effects/interactive-blur-reveal/interactive-blur-reveal-img01.webp",
  noiseSrc = "https://cdn-new.obsidianui.dev/effects/interactive-blur-reveal/interactive-blur-reveal-noise.png",
  iChannel0 = imageSrc,
  iChannel1 = noiseSrc,
  className,
  style,
