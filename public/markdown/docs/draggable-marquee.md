# ObsidianUI — Draggable Marquee

[Canonical page](https://www.obsidianui.dev/docs/draggable-marquee) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A continuous image marquee with drag momentum and a seamless looping track.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/draggable-marquee)
...
const items = [
  {
    "id": 1,
    "src": "https://cdn-new.obsidianui.dev/effects/draggable-marquee/draggable-marquee-img01.jpg?v=3",
  ...
  {
    "id": 2,
    "src": "https://cdn-new.obsidianui.dev/effects/draggable-marquee/draggable-marquee-img02.jpg?v=3",
  ...
  {
    "id": 3,
    "src": "https://cdn-new.obsidianui.dev/effects/draggable-marquee/draggable-marquee-img03.jpg?v=3",
  ...
  {
    "id": 4,
    "src": "https://cdn-new.obsidianui.dev/effects/draggable-marquee/draggable-marquee-img04.jpg?v=3",
...
Download the complete manifest: [draggable-marquee.json](https://www.obsidianui.dev/r/draggable-marquee.json). It includes every required local file and package dependency.
...
### components/block/draggable-marquee.jsx

Installation target: `@components/block/draggable-marquee.jsx`
...
### lib/effects/draggable-marquee/styles.css

Installation target: `@lib/effects/draggable-marquee/styles.css`
