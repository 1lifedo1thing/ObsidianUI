# ObsidianUI — Rectangular Text Reveal

[Canonical page](https://www.obsidianui.dev/docs/rectangular-text-reveal) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

Colored rectangles sweep across each line before revealing the text underneath.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/rectangular-text-reveal)
...
Download the complete manifest: [rectangular-text-reveal.json](https://www.obsidianui.dev/r/rectangular-text-reveal.json). It includes every required local file and package dependency.
...
### components/block/rectangular-text-reveal.jsx

Installation target: `@components/block/rectangular-text-reveal.jsx`
