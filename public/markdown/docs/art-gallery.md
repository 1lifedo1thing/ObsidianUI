# ObsidianUI — Art Gallery

[Canonical page](https://www.obsidianui.dev/docs/art-gallery) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A lensed photo grid you can drag through, with barrel distortion and infinite tiled studies.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/art-gallery)

Drag inside the preview to pan the gallery.
...
```bash
npx shadcn@latest add "https://www.obsidianui.dev/r/art-gallery.json"
```
...
Download the complete manifest: [art-gallery.json](https://www.obsidianui.dev/r/art-gallery.json). It includes every required local file and package dependency.

Install the listed package dependencies in your React project:

```bash
npm install clsx tailwind-merge three
```
...
### components/block/art-gallery.jsx

Installation target: `@components/block/art-gallery.jsx`
...
### components/ui/ripple-pulse-loader.tsx

Installation target: `@ui/ripple-pulse-loader.tsx`
...
Drag inside the preview to pan the gallery. The effect stays inside its container and respects reduced motion preferences.
