# ObsidianUI — Dither Canvas

[Canonical page](https://www.obsidianui.dev/docs/dither-canvas) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A video becomes a bright blue and cyan dither texture on white, with fluid distortion that follows your pointer.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/dither-canvas)
...
Download the complete manifest: [dither-canvas.json](https://www.obsidianui.dev/r/dither-canvas.json). It includes every required local file and package dependency.
...
export function DitherCanvas({
  videoSrc = "https://cdn-new.obsidianui.dev/effects/dither-canvas/dither-canvas-video.mp4?v=3",
  imageSrc = "https://cdn-new.obsidianui.dev/effects/dither-canvas/dither-canvas-poster.webp?v=3",
  className,
  style,
  paused = false,
} = {}) {
