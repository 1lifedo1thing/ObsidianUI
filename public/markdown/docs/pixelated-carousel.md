# ObsidianUI — Pixelated Carousel

[Canonical page](https://www.obsidianui.dev/docs/pixelated-carousel) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)
...
[Open the interactive component preview](https://www.obsidianui.dev/docs/pixelated-carousel)
...
Download the complete manifest: [pixelated-carousel.json](https://www.obsidianui.dev/r/pixelated-carousel.json). It includes every required local file and package dependency.
...
### components/block/pixelated-carousel.tsx

Installation target: `@components/block/pixelated-carousel.tsx`
