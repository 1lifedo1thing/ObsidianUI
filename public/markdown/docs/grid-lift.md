...
export function GridLift({ text = "OBSIDIANUI", imageSrc = "https://cdn-new.obsidianui.dev/effects/grid-lift/obsidianui-wordmark.svg?v=3", showControls = false, className, style } = {}) {
