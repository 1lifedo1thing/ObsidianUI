# ObsidianUI — Circle Menu

[Canonical page](https://www.obsidianui.dev/docs/circle-menu) · [Agent guide](https://www.obsidianui.dev/agent-instructions.md)

A radial navigation menu that expands in a circular pattern with smooth spring animations and hover effects.

## Preview

[Open the interactive component preview](https://www.obsidianui.dev/docs/circle-menu)
...
Download the complete manifest: [circle-menu.json](https://www.obsidianui.dev/r/circle-menu.json). It includes every required local file and package dependency.
...
### components/block/circle-menu.tsx

Installation target: `@components/block/circle-menu.tsx`
